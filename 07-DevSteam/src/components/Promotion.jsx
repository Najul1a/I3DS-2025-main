...
const Promotion = (props) => {
  ...
  // Embaralha os jogos apenas uma vez quando o componente é montado
  useEffect(() => {
    const shuffled = games
      .filter((jogo) => jogo.desconto > 0) // Filtra apenas jogos com desconto
  ...
  return (
    <div id="promotion" className="container w-75 my-4">
      ...
      >
        {/* Renderiza os jogos embaralhados */}
        {shuffledGames.slice(0, 3).map((jogo) => (
          <PromoCard
            key={jogo.id}
            titulo={jogo.titulo}
