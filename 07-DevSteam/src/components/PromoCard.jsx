  ...
  return (
    ...
    <div className="card-body d-flex flex-column gap-2">
      ...
      <div className="m-0 row h-100 align-items-center justify-content-center">
        <span className=" desconto col-4 h-100 fw-bold h5 m-0 py-3 text-center bg-success">
          -50%
        </span>
      ...
      <button id='addCarrinho' className="btn btn-success desconto text-light w-100 border-0">
